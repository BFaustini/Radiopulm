...
def run():
    ...
    with col2:
        ...
        #Choix des modèles
        models = st.multiselect('Modèles à comparer',['Lenet', 'VGG16', 'EfficientNetB1','Resnet101'],['Lenet', 'VGG16', 'EfficientNetB1','Resnet101'])
...
def init_resnet101() :
    ...
    resnet101.load_state_dict(torch.load(path+'/data/models/resnet_model.pth'))
    return resnet101
